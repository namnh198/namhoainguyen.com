            ...
            <Disclosure.Button
              className={cn('toggle-button flex gap-2 w-full items-start p-2 rounded-md', {
                'bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-700 toggle-open':
                  open && !props.color,
                'bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700': !open && !props.color,
                'bg-[#0000000a]': !!props.color
              })}
            >
              <BsFillCaretRightFill
                className={cn('mt-[3px] shrink-0 text-lg transform ease-in-out transition-all duration-[400ms]', {
                  'rotate-90': open,
                  'rotate-0': !open
                })}
              />
