...
export const usePostDateStatus = (createdDate?: string, modifiedDate?: string, withinDay?: number): PostDateStatus => {
  return useMemo(() => {
 ...
 */
export const getPostDateStatus = (createdDate?: string, modifiedDate?: string, withinDay?: number): PostDateStatus => {
