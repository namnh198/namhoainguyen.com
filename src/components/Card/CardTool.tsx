        ...
        >
          <div className="flex flex-wrap gap-1.5">
            {tool.isFree ? (
              ...
              <span className="px-2.5 py-1 rounded-md space-x-1 text-xs font-medium text-red-900 bg-red-200">
                paid
              </span>
            )}
            {!compactMode &&
              tool.tags?.map(tag => (
                <span
                  key={tag}
                  className="px-2.5 py-1 rounded-md space-x-1 text-xs bg-neutral-200 dark:bg-neutral-700"
                >
                  {tag}
                </span>
              ))}
