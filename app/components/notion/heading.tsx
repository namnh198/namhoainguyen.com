...
export function Heading({ block, children }: { block: Block; children?: React.ReactNode }) {
  ...
  if (isH1) {
    headerBlock = (
      <h1
        id={anchor}
        className={cn(headingCommonClassName, "text-5xl text-gradient notion-heading notion-h1")}
        data-id={id}
      >
        {innerHeader}
      </h1>
    ...
    headerBlock = (
      <h2
        id={anchor}
        className={cn(headingCommonClassName, "text-4xl text-gradient notion-heading notion-h2")}
        data-id={id}
      >
        {innerHeader}
      </h2>
    ...
    headerBlock = (
      <h3
        id={anchor}
        className={cn(headingCommonClassName, "text-2xl font-bold notion-heading notion-h3")}
        data-id={id}
      >
        {innerHeader}
      </h3>
