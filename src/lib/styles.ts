...
export const headingNoteImg = cn(
  'relative overflow-hidden h-24 lg:h-40 lg:w-40 ring-4 ring-white rounded-3xl sm:h-32 sm:w-32 w-24 z-0'
)

export const tagListContainerClass =
  'grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6 md:gap-8'
