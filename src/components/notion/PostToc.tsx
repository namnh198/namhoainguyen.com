          ...
          {props.tocs.map((toc) => {
            ...
            return (
              <a
                key={toc.id}
                href={`#${anchor}`}
                className={cn('flex items-baseline gap-2 hover:notion-link text-sm py-1 break-inside-avoid', {
                  ...
                  'text-slate-700 dark:text-slate-400 hover:notion-link-hover': activeId !== anchor || props.inPost
                })}
              >
